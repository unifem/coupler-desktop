...
To run the Docker image, first download the script [`ams529_desktop.py`](https://raw.githubusercontent.com/compdatasci/ams529-desktop/master/ams529_desktop.py)
...
default web browser on your computer. Simply replace `ams529_desktop.py` with `ams529_jupyter.py` in the preceding commands. That is, on Windows use the following commands in the PowerShell:
```
curl https://raw.githubusercontent.com/compdatasci/ams529-desktop/master/ams529_jupyter.py -outfile ams529_jupyter.py
